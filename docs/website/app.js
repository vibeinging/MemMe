...
<span class="cmt">// + Embedding computed on purified text</span>`
  ...
  },
  {
    ...
    desc: 'The orchestrator. Five phases run in sequence: decay old memories, extract atomic facts from each episode, reconcile new facts against existing memories (LLM decides ADD / UPDATE / DELETE), build knowledge graph, and link entities to memories via Aho-Corasick.',
    transform: {
      label_in: '1 episode, 47 existing memories',
      input: 'Episode "Q2 Planning with Alice" + 47 existing memories in store',
      label_out: 'Result',
      output: '3 memories created, 1 updated ("Alice\'s role" refined), 0 deleted, 2 entities linked, 1 relation added'
    },
...
<span class="cmt">// Phase 3: Reconcile \u2014 ADD 3, UPDATE 1, DELETE 0</span>
<span class="cmt">// Phase 4: Graph \u2014 2 entities, 1 relation</span>
<span class="cmt">// Phase 5: Link \u2014 Aho-Corasick entity\u2194memory</span>`
  },
  {
    title: 'Memories',
    badge: 'atomic facts',
